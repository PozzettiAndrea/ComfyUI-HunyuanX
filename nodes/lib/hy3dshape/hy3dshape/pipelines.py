...
def get_obj_from_str(string, reload=False):
    ...
    # Strip leading dot if present (handle old relative imports)
    ...
    # Import without package parameter - let Python resolve naturally
    # This works correctly after moving hy3dshape to lib/hy3dshape/
